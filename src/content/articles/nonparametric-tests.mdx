---
title: "Nonparametric Tests: When and How to Use Them"
description: "Nonparametric tests compare groups or measure association without assuming a normal distribution; use this map to match your data to the right test."
