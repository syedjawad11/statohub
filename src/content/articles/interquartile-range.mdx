...
Subtract the first quartile from the third: **IQR = Q3 − Q1**. It measures the spread of the middle 50 percent of a sorted data set and is not influenced by extreme values at either end.

### What is interquartile range used for?

It describes the spread of the central portion of a distribution, anchors the box in a boxplot, and powers Tukey's 1.5 × IQR outlier-detection rule. It is also used to compare variability between groups when outliers make the standard deviation unreliable.
