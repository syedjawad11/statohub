---
title: "Heteroscedasticity Test: Which One to Use"
description: "Run a heteroscedasticity test by plotting residuals, then confirm with Breusch-Pagan, Koenker, or White, and switch to HC3 robust standard errors if it fails."
