...
When two or more regression equations are proposed for the same dataset, several criteria decide which fits best; use them together for a complete picture.
