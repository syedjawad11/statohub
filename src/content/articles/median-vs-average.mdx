...
Usually, though, the question behind the question is whether the median and the mean will give the same number. They do only when the data is symmetric and free of outliers.
