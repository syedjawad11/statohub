...
"The mean exam score of students taught by Method A equals the mean exam score of students taught by Method B (H₀: μ_A = μ_B)." This asserts that the two teaching methods produce identical average outcomes. The paired alternative would be H₁: μ_A ≠ μ_B.
