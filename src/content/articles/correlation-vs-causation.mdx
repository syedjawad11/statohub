...
The NIST/SEMATECH e-Handbook of Statistical Methods discusses the interpretation of correlation coefficients and the importance of experimental controls for establishing genuine relationships between variables: [https://www.itl.nist.gov/div898/handbook/eda/section3/eda333.htm](https://www.itl.nist.gov/div898/handbook/eda/section3/eda333.htm).
...
When a correlation is a strong causal candidate, researchers use several strategies to test the causal claim more rigorously.
