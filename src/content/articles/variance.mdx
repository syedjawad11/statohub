...
description: "Variance measures how spread out data values are from the mean. Learn the variance definition, formula for variance, and how variance vs standard deviation differ."
