...
description: "An average is a single number that represents a set of values. Learn the average definition, mean formula, and when to use mean, median, or mode."
