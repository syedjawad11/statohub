...
h1: "0.5 vs 2.0: Confidence vs Prediction Intervals"
description: "Confidence interval vs prediction interval, compared: a CI estimates a population parameter, while a PI bounds one future value and is always wider."
