...
description: "A probability distribution maps every outcome to its probability. Learn types, how to calculate the distribution mean, marginal distributions, and Bayesian uses."
