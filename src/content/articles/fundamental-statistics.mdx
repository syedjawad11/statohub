...
The calculations that power the descriptive and inferential tools above are surprisingly accessible at entry level; the advanced ones build on the same algebra and calculus you already know. The open-access textbook [OpenStax *Introductory Statistics*, Chapter 1](https://openstax.org/books/introductory-statistics/pages/1-introduction) covers the same ground with worked examples and free exercises.
...
Any situation where you summarise data you already have without generalising to a larger group. A teacher averaging exam scores, a coach reporting a player's season batting average, or a pollster reporting the percentage of respondents who favour a candidate are all describing the data in hand. The inferential step only arrives when the pollster projects that percentage onto all voters.

### What is the difference between descriptive and inferential statistics?

One describes the data in hand; the other uses that data to draw conclusions about a broader population. "The average age of participants in this study was 34.2 years" is descriptive. "Based on this sample, we estimate the average age of adults in the city to be between 33.1 and 35.3 years (95% confidence)" is inferential.

---

## Building Your Statistics Foundation

Fundamental statistics is not a single technique — it is a way of thinking about data: *what did I observe, how sure am I, and what does it imply?* The two branches (descriptive and inferential) answer those three questions in order, and the core calculations — mean, median, variance, standard deviation, z-score — are the tools you reach for at every step.
